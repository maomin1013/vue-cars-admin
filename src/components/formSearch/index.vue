<template>
  <el-form inline
    ref="form"
    :model="form_data">
    <el-form-item v-for="item in formItme"
      :key="item.prop"
      :label="item.label"
      :prop="item.prop"
      :rules="item.rules">
    ...
    <el-form-item>
      ...
      <el-button type="danger"
        @click="reset"
        v-if="formConfig.resetButton">重置</el-button>
      <template v-for="item in formHandler">
        <el-button v-if="item.element === 'link'"
          :key="item.key"
          :type="item.type">
        ...
        <el-button v-if="item.element === 'button'"
          :key="item.key"
          :type="item.type"
